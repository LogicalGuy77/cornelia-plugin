...
const MainContent = memo(
  ...
  (prevProps, nextProps) => {
    ...
    return (
      ...
      prevProps.documentContent === nextProps.documentContent &&
      prevProps.summaryLoading === nextProps.summaryLoading &&
      prevProps.chatLoading === nextProps.chatLoading &&
      prevProps.clauseAnalysisLoading === nextProps.clauseAnalysisLoading &&
      prevProps.isRedraftModalVisible === nextProps.isRedraftModalVisible &&
      prevProps.isBrainstormModalVisible === nextProps.isBrainstormModalVisible
    );
  }
);
